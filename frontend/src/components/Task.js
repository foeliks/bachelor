...
function Task(props) {
    ...
    if (!task.required_stars || task.required_stars < props.values.categories.sum_stars) {
        return (
            <div>
        ...
        <div>
            ...
            <Card title="Hoppla" style={{ marginTop: "10px", border: '2px solid', borderColor: 'red' }} >
                <p>
                    ...
                    <br />
                    Du hast bisher {props.values.categories.sum_stars ? props.values.categories.sum_stars : 0} und benötigst {task.required_stars}.
                    <br />
